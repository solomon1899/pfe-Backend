...
import com.ird.faa.service.moderateur.facade.GestionReclamationModerateurService;
...
@RestController
@RequestMapping("api/moderateur/gestionReclamation")
public class GestionReclamationRestModerateur {

@Autowired
private GestionReclamationModerateurService gestionReclamationService;
