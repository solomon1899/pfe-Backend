...
@Service
public class DemandeEstivageCentreModerateurServiceImpl extends AbstractServiceImpl<DemandeEstivageCentre> implements DemandeEstivageCentreModerateurService {

@Autowired
private DemandeEstivageCentreDao demandeEstivageCentreDao;

        @Autowired
        private DemandeEstivageModerateurService demandeEstivageService ;
        @Autowired
