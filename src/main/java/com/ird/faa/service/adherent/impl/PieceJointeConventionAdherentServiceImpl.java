...
@Service
public class PieceJointeConventionAdherentServiceImpl extends AbstractServiceImpl<PieceJointeConvention> implements PieceJointeConventionAdherentService {
