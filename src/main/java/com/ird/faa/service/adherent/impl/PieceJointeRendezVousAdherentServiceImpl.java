...
@Service
public class PieceJointeRendezVousAdherentServiceImpl extends AbstractServiceImpl<PieceJointeRendezVous> implements PieceJointeRendezVousAdherentService {
