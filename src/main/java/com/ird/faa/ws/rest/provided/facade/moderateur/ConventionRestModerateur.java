...
import com.ird.faa.service.moderateur.facade.ConventionModerateurService;
...
@RestController
@RequestMapping("api/moderateur/convention")
public class ConventionRestModerateur {

@Autowired
private ConventionModerateurService conventionService;
...
private ConventionConverter conventionConverter;
    ...
    public List<ConventionVo> findByCriteria(@RequestBody ConventionVo conventionVo){
        ...
        return conventionService.deleteByOrganismeId(id);
            ...
            @PutMapping("/archiver/")
            public ConventionVo archiver(@RequestBody ConventionVo conventionVo){
                Convention convention = conventionService.archiver(conventionConverter.toItem(conventionVo));
                return conventionConverter.toVo(convention);
                }

            @PutMapping("/desarchiver/")
            public ConventionVo desarchiver(@RequestBody ConventionVo conventionVo){
                Convention convention = conventionService.desarchiver(conventionConverter.toItem(conventionVo));
                return conventionConverter.toVo(convention);}
            }
