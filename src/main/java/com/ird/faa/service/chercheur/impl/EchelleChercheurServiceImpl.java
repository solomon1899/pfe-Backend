...
import com.ird.faa.service.chercheur.facade.EchelleChercheurService;
        import com.ird.faa.service.chercheur.facade.EchelonChercheurService;
...
@Service
public class EchelleChercheurServiceImpl extends AbstractServiceImpl<Echelle> implements EchelleChercheurService {

@Autowired
private EchelleDao echelleDao;

        @Autowired
        private EchelonChercheurService echelonService ;
