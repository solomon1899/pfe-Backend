...
import com.ird.faa.service.admin.facade.ImpressionCarteAdminService;
...
@RestController
@RequestMapping("api/admin/impressionCarte")
public class ImpressionCarteRestAdmin {

@Autowired
private ImpressionCarteAdminService impressionCarteService;
