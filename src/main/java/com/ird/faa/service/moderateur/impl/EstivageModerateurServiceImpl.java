...
@Service
public class EstivageModerateurServiceImpl extends AbstractServiceImpl<Estivage> implements EstivageModerateurService {
...
public Estivage findByIdWithAssociatedList(Long id){
    ...
    @Override
    public Estivage archiver(Estivage estivage) {
    if (estivage.getArchive() == null) {
    estivage.setArchive(false);
    }
    estivage.setArchive(true);
    estivage.setDateArchivage(new Date());
    ...
    @Override
    public Estivage desarchiver(Estivage estivage) {
    if (estivage.getArchive() == null) {
    estivage.setArchive(false);
    }
    estivage.setArchive(false);
    estivage.setDateArchivage(null);
    estivageDao.save(estivage);
    return estivage;
    }
