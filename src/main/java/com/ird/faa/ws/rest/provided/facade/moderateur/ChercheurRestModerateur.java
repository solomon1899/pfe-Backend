...
import com.ird.faa.service.moderateur.facade.ChercheurModerateurService;
...
@RestController
@RequestMapping("api/moderateur/chercheur")
public class ChercheurRestModerateur {

@Autowired
private ChercheurModerateurService chercheurService;
