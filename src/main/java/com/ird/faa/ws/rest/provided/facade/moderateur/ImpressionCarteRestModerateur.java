...
import com.ird.faa.service.moderateur.facade.ImpressionCarteModerateurService;
...
@RestController
@RequestMapping("api/moderateur/impressionCarte")
public class ImpressionCarteRestModerateur {

@Autowired
private ImpressionCarteModerateurService impressionCarteService;
