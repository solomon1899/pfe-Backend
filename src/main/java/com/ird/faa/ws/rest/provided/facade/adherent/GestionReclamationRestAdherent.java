...
@RestController
@RequestMapping("api/adherent/gestionReclamation")
public class GestionReclamationRestAdherent {

@Autowired
private GestionReclamationAdherentService gestionReclamationService;
