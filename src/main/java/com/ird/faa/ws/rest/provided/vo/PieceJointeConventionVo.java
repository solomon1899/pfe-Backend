...
public class PieceJointeConventionVo {
    ...
    private String username ;
        ...
        private ConventionVo conventionVo ;


    public PieceJointeConventionVo(){
    super();
    }
        ...
        public ConventionVo getConventionVo(){
        return this.conventionVo;
        }

        public void setConventionVo(ConventionVo conventionVo){
        this.conventionVo = conventionVo;
        }
