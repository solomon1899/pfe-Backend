...
@Service
public class VilleModerateurServiceImpl extends AbstractServiceImpl<Ville> implements VilleModerateurService {

@Autowired
private VilleDao villeDao;

        @Autowired
        private RegionModerateurService regionService ;
