...
@Service
public class ModerateurChercheurServiceImpl extends AbstractServiceImpl<Moderateur> implements ModerateurChercheurService {

@Autowired
private ModerateurDao moderateurDao;

        @Autowired
        private ProfilChercheurService profilService ;
        @Autowired
