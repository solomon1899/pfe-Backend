...
import com.ird.faa.service.adherent.facade.EstivageAdherentService;
        import com.ird.faa.service.adherent.facade.CentreEstivageAdherentService;
...
@Service
public class EstivageAdherentServiceImpl extends AbstractServiceImpl<Estivage> implements EstivageAdherentService {
...
private EstivageDao estivageDao;
    ...
    private ArchivableService<Estivage> archivableService;
        @Autowired
        private CentreEstivageAdherentService centreEstivageService ;
        @Autowired
