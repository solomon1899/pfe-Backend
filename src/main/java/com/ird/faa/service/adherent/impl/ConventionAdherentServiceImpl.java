...
import com.ird.faa.service.adherent.facade.ConventionAdherentService;
        import com.ird.faa.service.adherent.facade.OrganismeAdherentService;
        import com.ird.faa.service.adherent.facade.PieceJointeConventionAdherentService;
...
@Service
public class ConventionAdherentServiceImpl extends AbstractServiceImpl<Convention> implements ConventionAdherentService {
...
private ConventionDao conventionDao;
    ...
    private ArchivableService<Convention> archivableService;
        @Autowired
        private OrganismeAdherentService organismeService ;
        @Autowired
        private PieceJointeConventionAdherentService pieceJointeConventionService ;
...
public Convention findByIdWithAssociatedList(Long id){
    ...
    @Override
    public Convention archiver(Convention convention) {
    if (convention.getArchive() == null) {
    convention.setArchive(false);
    }
    convention.setArchive(true);
    ...
    @Override
    public Convention desarchiver(Convention convention) {
    if (convention.getArchive() == null) {
    convention.setArchive(false);
    }
    convention.setArchive(false);
    convention.setDateArchivage(null);
    conventionDao.save(convention);
    return convention;
    }
