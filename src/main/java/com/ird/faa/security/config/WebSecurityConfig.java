...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/actuator/info").permitAll();
            ...
            http.authorizeRequests().antMatchers("/api/adherent/login").permitAll();
            http.authorizeRequests().antMatchers("/api/moderateur/login").permitAll();
            ...
            http.authorizeRequests().antMatchers("/api/adherent/").hasAnyAuthority(AuthoritiesConstants.ADHERENT);
            http.authorizeRequests().antMatchers("/api/moderateur/").hasAnyAuthority(AuthoritiesConstants.MODERATEUR);
