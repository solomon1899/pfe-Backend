...
import com.ird.faa.service.admin.facade.GestionReclamationAdminService;
...
@RestController
@RequestMapping("api/admin/gestionReclamation")
public class GestionReclamationRestAdmin {

@Autowired
private GestionReclamationAdminService gestionReclamationService;
