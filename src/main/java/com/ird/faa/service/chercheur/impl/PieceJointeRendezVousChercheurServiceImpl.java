...
import com.ird.faa.service.chercheur.facade.PieceJointeRendezVousChercheurService;
        import com.ird.faa.service.chercheur.facade.RendezVousChercheurService;
...
@Service
public class PieceJointeRendezVousChercheurServiceImpl extends AbstractServiceImpl<PieceJointeRendezVous> implements PieceJointeRendezVousChercheurService {
...
private PieceJointeRendezVousDao pieceJointeRendezVousDao;
    ...
    private ArchivableService<PieceJointeRendezVous> archivableService;
        @Autowired
        private RendezVousChercheurService rendezVousService ;
...
public List<PieceJointeRendezVous> findAll(){
    List<PieceJointeRendezVous> resultat= new ArrayList();
...
return  pieceJointeRendezVousDao.save(pieceJointeRendezVous);
    ...
    private void prepareSave(PieceJointeRendezVous pieceJointeRendezVous){
        pieceJointeRendezVous.setDateCreation(new Date());
            ...
            pieceJointeRendezVous.setUsername(currentUser.getUsername());
            }
...
pieceJointeRendezVouss.forEach(e->pieceJointeRendezVousDao.save(e));
        ...
        public List<PieceJointeRendezVous> findAllNonArchive(){
        String query = "SELECT o FROM PieceJointeRendezVous o  WHERE o.archive != true AND o.visible = true";
        return entityManager.createQuery(query).getResultList();
        }

        public List<PieceJointeRendezVous> findAllByOwner(){
        List<PieceJointeRendezVous> result= new ArrayList();
        User currentUser = SecurityUtil.getCurrentUser();
        if (currentUser != null && StringUtil.isNotEmpty(currentUser.getUsername())){
        String query = "SELECT o FROM PieceJointeRendezVous o  WHERE o.archive != true AND o.visible = false AND o.username = '"+ currentUser.getUsername()+"'";
