...
@Service
public class EchelleAdherentServiceImpl extends AbstractServiceImpl<Echelle> implements EchelleAdherentService {

@Autowired
private EchelleDao echelleDao;

        @Autowired
        private EchelonAdherentService echelonService ;
