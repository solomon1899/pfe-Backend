...
public class PieceJointeRendezVousVo {
    ...
    private String username ;
        ...
        private RendezVousVo rendezVousVo ;


    public PieceJointeRendezVousVo(){
    super();
    }
        ...
        public RendezVousVo getRendezVousVo(){
        return this.rendezVousVo;
        }

        public void setRendezVousVo(RendezVousVo rendezVousVo){
        this.rendezVousVo = rendezVousVo;
        }
