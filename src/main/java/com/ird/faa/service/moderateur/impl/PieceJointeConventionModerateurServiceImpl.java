...
@Service
public class PieceJointeConventionModerateurServiceImpl extends AbstractServiceImpl<PieceJointeConvention> implements PieceJointeConventionModerateurService {
