...
public class PieceJointePrestationVo {
    ...
    private String username ;
        ...
        private PrestationVo prestationVo ;


    public PieceJointePrestationVo(){
    super();
    }
        ...
        return this.prestationVo;
        }

        public void setPrestationVo(PrestationVo prestationVo){
        this.prestationVo = prestationVo;
        }
