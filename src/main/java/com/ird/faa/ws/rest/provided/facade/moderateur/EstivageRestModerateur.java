...
@RestController
@RequestMapping("api/moderateur/estivage")
public class EstivageRestModerateur {
...
private EstivageConverter estivageConverter;
    ...
    public List<EstivageVo> findByCriteria(@RequestBody EstivageVo estivageVo){
        ...
        return estivageService.deleteByNiveauImportanceId(id);
            ...
            @PutMapping("/archiver/")
            public EstivageVo archiver(@RequestBody EstivageVo estivageVo){
                Estivage estivage = estivageService.archiver(estivageConverter.toItem(estivageVo));
                return estivageConverter.toVo(estivage);
                }

            @PutMapping("/desarchiver/")
            public EstivageVo desarchiver(@RequestBody EstivageVo estivageVo){
                Estivage estivage = estivageService.desarchiver(estivageConverter.toItem(estivageVo));
                return estivageConverter.toVo(estivage);}
            }
