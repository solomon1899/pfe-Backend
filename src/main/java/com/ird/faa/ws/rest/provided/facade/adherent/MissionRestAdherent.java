...
@RestController
@RequestMapping("api/adherent/mission")
public class MissionRestAdherent {

@Autowired
private MissionAdherentService missionService;
...
private MissionConverter missionConverter;
    ...
    public List<MissionVo> findByCriteria(@RequestBody MissionVo missionVo){
        ...
        public List<Mission> findByVilleDestinationId(@PathVariable Long id){
        ...
        return missionService.deleteByModerateurId(id);
            ...
            @PutMapping("/archiver/")
            public MissionVo archiver(@RequestBody MissionVo missionVo){
                Mission mission = missionService.archiver(missionConverter.toItem(missionVo));
                return missionConverter.toVo(mission);
                }

            @PutMapping("/desarchiver/")
            public MissionVo desarchiver(@RequestBody MissionVo missionVo){
                Mission mission = missionService.desarchiver(missionConverter.toItem(missionVo));
                return missionConverter.toVo(mission);}
            }
