...
@RestController
@RequestMapping("api/moderateur/pieceJointeProduit")
public class PieceJointeProduitRestModerateur {
...
private PieceJointeProduitConverter pieceJointeProduitConverter;
    ...
    public List<PieceJointeProduitVo> findByCriteria(@RequestBody PieceJointeProduitVo pieceJointeProduitVo){
        ...
        return pieceJointeProduitService.deleteByProduitId(id);
            ...
            @PutMapping("/archiver/")
            public PieceJointeProduitVo archiver(@RequestBody PieceJointeProduitVo pieceJointeProduitVo){
                PieceJointeProduit pieceJointeProduit = pieceJointeProduitService.archiver(pieceJointeProduitConverter.toItem(pieceJointeProduitVo));
                return pieceJointeProduitConverter.toVo(pieceJointeProduit);
                }

            @PutMapping("/desarchiver/")
            public PieceJointeProduitVo desarchiver(@RequestBody PieceJointeProduitVo pieceJointeProduitVo){
                PieceJointeProduit pieceJointeProduit = pieceJointeProduitService.desarchiver(pieceJointeProduitConverter.toItem(pieceJointeProduitVo));
                return pieceJointeProduitConverter.toVo(pieceJointeProduit);}
            }
