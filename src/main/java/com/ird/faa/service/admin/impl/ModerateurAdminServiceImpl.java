...
import com.ird.faa.service.admin.facade.ModerateurAdminService;
        ...
        import com.ird.faa.service.admin.facade.TacheAdminService;
...
@Service
public class ModerateurAdminServiceImpl extends AbstractServiceImpl<Moderateur> implements ModerateurAdminService {

@Autowired
private ModerateurDao moderateurDao;

        @Autowired
        private ProfilAdminService profilService ;
        @Autowired
        private SituationModerateurAdminService situationModerateurService ;
        @Autowired
