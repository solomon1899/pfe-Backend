...
public interface RendezVousModerateurService extends AbstractService<RendezVous,Long,RendezVousVo>{
...
/**
    ...
    */
    ...
    RendezVous archiver(RendezVous rendezVous) ;
    RendezVous desarchiver(RendezVous rendezVous);
