...
@Service
public class PieceJointePrestationAdherentServiceImpl extends AbstractServiceImpl<PieceJointePrestation> implements PieceJointePrestationAdherentService {
